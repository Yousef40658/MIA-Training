...
#Data
#--------------
Hassan = ["speed", "aggression", "adaptability", "technical skill", "teamwork",
"risk-taking", "consistency"]
teams = {
"Red_Bull" : ["speed", "aggression", "adaptability", "technical skill", "teamwork",
"risk-taking", "inconsistency"],
"Ferrari" : ["passion", "emotion", "adaptability", "technical skill", "teamwork",
"risk-taking", "inconsistency"],
"Mercedes" :  ["precision", "discipline", "adaptability", "technical skill",
"teamwork", "control", "consistency"]
}

#embedding
glove = api.load("glove-wiki-gigaword-100") #load pre-trained vectors(100 dim)

def get_vector(words) :
    vectors = [glove[word] for word in words if word in glove]
    if not vectors :
        return np.zeros(100) #no word found
    return np.mean(vectors,axis=0)

Hassan = get_vector(Hassan)
